...
class Configuration():
    ...
    def __init__(self, a=5, b=5, c=5, nMolecules=50,atomradius=0.4, seed=24234444):
        self.a = a
        self.b = b
        self.c = c
    ...
    def writeOutput(self, filename):
        ...
        with open(filename, "w") as f:
            ...
            f.write('species'+'     '+ '0'+'\n')
            f.write('nMolecule' + '      ' +'25'+'\n'+'\n') 
            for each in self.molecules[:25]:
            ...
            f.write('species'+'        '+ '1'+'\n')
            f.write('nMolecule' + '        ' +'25'+'\n'+'\n') 
            for each in self.molecules[25:50]:
                f.write("molecule" + '        ' + str(id) + '\n')
                f.write('    ' + format(each[0], '.10e') + '    ' + format(each[1], '.10e') + '    ' + format(each[2], '.10e')+'\n'+'\n')
                id += 1
