#ifndef MCMD_BOUNDARY_ENSEMBLE_CPP
...
namespace Util{
   ...
   */
   MPI::Datatype MpiTraits<McMd::BoundaryEnsemble>::type = MPI::BYTE;
   bool MpiTraits<McMd::BoundaryEnsemble>::hasType = false;

   /**
   * Initialize BoundaryEnsemble::Type MPI Datatype.
   */
   MPI::Datatype MpiTraits<McMd::BoundaryEnsemble::Type>::type = MPI::INT;
   bool MpiTraits<McMd::BoundaryEnsemble::Type>::hasType = true;
...
namespace McMd
{
   ...
   */
   void BoundaryEnsemble::commitMpiType()
   {
      ...
      Util::MpiTraits<McMd::BoundaryEnsemble>::hasType = true;
   }
