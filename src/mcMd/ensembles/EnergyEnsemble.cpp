#ifndef MCMD_ENERGY_ENSEMBLE_CPP
...
namespace Util{
   ...
   */
   MPI::Datatype MpiTraits<McMd::EnergyEnsemble>::type = MPI::BYTE;
   bool MpiTraits<McMd::EnergyEnsemble>::hasType = false;

   /**
   * Initialize EnergyEnsemble::Type MPI Datatype.
   */
   MPI::Datatype MpiTraits<McMd::EnergyEnsemble::Type>::type = MPI::INT;
   bool MpiTraits<McMd::EnergyEnsemble::Type>::hasType = true;
...
namespace McMd
{
   ...
   */
   void EnergyEnsemble::commitMpiType()
   {
      ...
      Util::MpiTraits<McMd::EnergyEnsemble>::hasType = true;
   }
