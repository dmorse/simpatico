...
namespace Util
{
   ...
   template <>
   void send<McMd::OrthorhombicBoundary>(MPI::Comm& comm, 
             McMd::OrthorhombicBoundary& data, int dest, int tag)
   {
   ...
   template <>
   void recv<McMd::OrthorhombicBoundary>(MPI::Comm& comm, 
             McMd::OrthorhombicBoundary& data, int source, int tag)
   {
      Vector lengths;
   ...
   template <>
   void bcast<McMd::OrthorhombicBoundary>(MPI::Intracomm& comm, 
              McMd::OrthorhombicBoundary& data, int root)
   {
      Vector lengths; 
   ...
   */
   MPI::Datatype MpiTraits<McMd::OrthorhombicBoundary>::type = MPI::BYTE;
   bool MpiTraits<McMd::OrthorhombicBoundary>::hasType = false;
