#ifndef MCMD_FINE_EWALD_COULOMB_POTENTIAL_H
#define MCMD_FINE_EWALD_COULOMB_POTENTIAL_H
...
namespace McMd
{
   ...
   */
   ...
   public:
      ...
      * Constructor.
      */
      FineEwaldCoulombPotential(System& system);

      /**
      * Destructor (does nothing).
      */
      virtual ~FineEwaldCoulombPotential();
   ...
   protected:
      ...
      /// Range of wave indices.
      Pair<int>            range0_;
      GArray< Pair<int> >  range1_;
      GArray< Pair<int> >  range2_;
