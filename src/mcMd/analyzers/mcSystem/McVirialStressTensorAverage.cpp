#ifndef MCMD_VIRIAL_STRESSTENSOR_AVERAGE_CPP
#define MCMD_VIRIAL_STRESSTENSOR_AVERAGE_CPP
...
namespace McMd
{
   ...
   * Constructor.
   */
   McVirialStressTensorAverage::McVirialStressTensorAverage(McSystem& system) 
   ...
   {  setClassName("McVirialStressTensorAverage"); }

   /*
   * Read interval and outputFileName. 
   */
   void McVirialStressTensorAverage::readParameters(std::istream& in) 
   {
      readInterval(in);
   ...
   */
   void McVirialStressTensorAverage::loadParameters(Serializable::IArchive &ar)
   {
   ...
   */
   void McVirialStressTensorAverage::save(Serializable::OArchive &ar)
   {  ar & *this; }
   ...
   * Read interval and outputFileName. 
   */
   void McVirialStressTensorAverage::clear() 
   {
      if (!isInitialized_) {
   ...
   */
   void McVirialStressTensorAverage::sample(long iStep) 
   {
   ...
   */
   void McVirialStressTensorAverage::output() 
   {
