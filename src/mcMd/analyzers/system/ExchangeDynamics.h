#ifndef MCMD_EXCHANGE_DYNAMICS_H
#define MCMD_EXCHANGE_DYNAMICS_H
...
namespace McMd
{
   ...
   */
   class ExchangeDynamics : public SystemAnalyzer<System>
   {
   ...
   public:
      ...
      */
      ExchangeDynamics(System &system);
   ...
   */
   template <class Archive>
   void ExchangeDynamics::serialize(Archive& ar, const unsigned int version)
   {  
