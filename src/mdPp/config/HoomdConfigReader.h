#ifndef MDPP_HOOMD_CONFIG_READER_H
#define MDPP_HOOMD_CONFIG_READER_H
...
#include <mdPp/config/ConfigReader.h>   // base class
#include <mdPp/config/TypeMap.h>        // member
...
namespace MdPp
{
   ...
   *
   * \sa \ref mdPp_config_HoomdTypeMap_page
   *
