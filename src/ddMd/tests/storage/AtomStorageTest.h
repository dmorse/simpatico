...
inline void AtomStorageTest::testAddAtoms()
{
   ...
   TEST_ASSERT(map_.findLocal(53) == ptr53);
   ...
   TEST_ASSERT(map_.findLocal(18) == ptr18);
   ...
   TEST_ASSERT(map_.findLocal(53) == ptr53);
   TEST_ASSERT(ptr53->id() == 53);
   TEST_ASSERT(map_.findGhost(35) == ptr35);
...
void AtomStorageTest::testAddRemoveAtoms()
{
   ...
   TEST_ASSERT(map_.findLocal(53) == 0);
   ...
   TEST_ASSERT(map_.findLocal(18) == ptr18);
   TEST_ASSERT(ptr18->id() == 18);
   TEST_ASSERT(map_.findLocal(67) == ptr67);
   TEST_ASSERT(ptr67->id() == 67);
   TEST_ASSERT(map_.findLocal(44) == ptr44);
   ...
   TEST_ASSERT(map_.findGhost(82) == ptr82);
   ...
   TEST_ASSERT(map_.findLocal(53) == 0);
   TEST_ASSERT(map_.findGhost(35) == 0);
...
void AtomStorageTest::testClear()
{
   ...
   TEST_ASSERT(map_.findLocal(18) == ptr18);
   TEST_ASSERT(ptr18->id() == 18);
   TEST_ASSERT(map_.findLocal(39) == ptr39);
   ...
   TEST_ASSERT(map_.findLocal(82) == ptr82);
   TEST_ASSERT(ptr82->id() == 82);
   TEST_ASSERT(map_.findLocal(53) == ptr53);
   TEST_ASSERT(ptr53->id() == 53);
...
void AtomStorageTest::testSnapshot()
{
   ...
   ptr = map_.findLocal(53);
   TEST_ASSERT(ptr !=0 );
   ptr->position()[0] = 0.1;
   ptr->position()[1] = 1.1;
   ptr->position()[2] = 2.1;

   ptr = map_.findLocal(35);
   TEST_ASSERT(ptr !=0 );
   ptr->position()[0] = 0.2;
   ptr->position()[1] = 3.1;
   ptr->position()[2] = 2.8;

   ptr = map_.findLocal(18);
   TEST_ASSERT(ptr !=0 );
   ptr->position()[0] = 5.2;
   ptr->position()[1] = 2.1;
   ptr->position()[2] = 2.7;

   ptr = map_.findLocal(44);
   TEST_ASSERT(ptr !=0 );
   ptr->position()[0] = 5.2;
   ptr->position()[1] = 2.1;
   ptr->position()[2] = 2.7;

   ptr = map_.findLocal(17);
   TEST_ASSERT(ptr !=0 );
   ptr->position()[0] = 2.4;
   ptr->position()[1] = 8.8;
   ptr->position()[2] = 3.7;
   ...
   ptr->position()[1] +=  0.15;
   ptr->position()[2] +=  0.25;
   ptr = map_.findLocal(17); // maximum displacement
   ptr->position()[0] +=  0.20;
   ptr->position()[1] +=  0.05;
   ptr->position()[2] += -0.30;
