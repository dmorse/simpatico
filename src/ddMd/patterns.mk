...
# after inclusion of the main config.mk configuration file.
#-----------------------------------------------------------------------
...
DDMD_ADEF=$(UTIL_DEFS) $(SIMP_DEFS) $(DDMD_DEFS)
...
$(BLD_DIR)/ddMd/%.o: $(SRC_DIR)/ddMd/%.cpp
	$(CXX) $(INCLUDES) $(DDMD_ADEF) $(CXXFLAGS) -c -o $@ $<
ifdef MAKEDEP
	$(MAKEDEP) $(INCLUDES) $(DDMD_ADEF) $(CXXFLAGS) $(DDMD_CFGS) -S$(SRC_DIR) -B$(BLD_DIR) $<
endif
...
$(BLD_DIR)/ddMd/tests/%.o: $(SRC_DIR)/ddMd/tests/%.cc 
	$(CXX) $(INCLUDES) $(DDMD_ADEF) $(TESTFLAGS) -c -o $@ $<
ifdef MAKEDEP
	$(MAKEDEP) $(INCLUDES) $(DDMD_ADEF) $(TESTFLAGS) $(DDMD_CFGS) -S$(SRC_DIR) -B$(BLD_DIR) $<
endif
