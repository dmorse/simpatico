#ifndef DDMD_SP_CELL_LIST_H
#define DDMD_SP_CELL_LIST_H
...
namespace DdMd
{
   ...
   */
   ...
   public:
      ...
      */
      ...
      /**
      * Has memory been allocated for this SpCellList?
      */
   ...
   */
   inline const Grid& SpCellList::grid() const
   {  return grid_; }

   /*
   * Return length of each cell in direction i.
   */
   inline double SpCellList::cellLength(int i) const
   ...
   */
   ...
   /*
   * Is this SpCellList allocated?
   */
   inline bool SpCellList::isAllocated() const
