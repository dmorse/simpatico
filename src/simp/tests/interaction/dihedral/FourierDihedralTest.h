#ifndef FOURIER_DIHEDRAL_TEST_H
#define FOURIER_DIHEDRAL_TEST_H
...
class FourierDihedralTest 
 : public DihedralTestTemplate<FourierDihedral>
{

protected:

   using DihedralTestTemplate<FourierDihedral>::setNDihedralType;
   using DihedralTestTemplate<FourierDihedral>::readParamFile;
...
public:
   ...
   void setUp() {
      eps_ = 1.0E-6;
      setNDihedralType(1);
      readParamFile("in/FourierDihedral");
   }
...
TEST_BEGIN(FourierDihedralTest)
TEST_ADD(FourierDihedralTest, testSetUp)
TEST_ADD(FourierDihedralTest, testGet)
TEST_ADD(FourierDihedralTest, testSetGet)
TEST_ADD(FourierDihedralTest, testEnergy)
TEST_ADD(FourierDihedralTest, testForce)
TEST_END(FourierDihedralTest)
