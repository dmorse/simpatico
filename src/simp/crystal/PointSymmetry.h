#ifndef SIMP_POINT_SYMMETRY_H
#define SIMP_POINT_SYMMETRY_H
...
namespace Simp 
{
   ...
   /**
   * A PointSymmetry represents a crystallographic point group symmetry operation.
   *
   * Point group symmetry operations included 2, 3, and 4 fold rotations about
   * axes, reflections through planes and inversion. Each such symmetry may be
