#ifndef MCMD_GENERALPOLYMER_LIMITED_SEMI_GRAND_MOVE_H
#define MCMD_GENERALPOLYMER_LIMITED_SEMI_GRAND_MOVE_H
...
namespace McMd
{
   ...
   */
   class GeneralpolymerLimitedSemiGrandMove : public SystemMove
   {
   ...
   public:
      ...
      * Constructor. 
      */
      GeneralpolymerLimitedSemiGrandMove(McSystem& system);
