...
/**
* \defgroup Ensemble_Module Ensembles
*
* This module contains classes that represent statistical ensembles 
* for particular macroscopic variables. The classes EnergyEnsemble,
* BoundaryEnsemble, and SpeciesEnsemble represent statistical 
* ensembles for fluctuations of energy, boundary volume or shape, 
* and number of molecules of a single species, respectively. 
*
