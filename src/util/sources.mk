...
util_SRCS=$(util_util_SRCS) $(util_format_SRCS) $(util_containers_SRCS) \
    $(util_mpi_SRCS) $(util_param_SRCS) $(util_math_SRCS) $(util_space_SRCS) \
    $(util_random_SRCS) $(util_crystal_SRCS) $(util_accumulators_SRCS) \
    $(util_archives_SRCS) 
